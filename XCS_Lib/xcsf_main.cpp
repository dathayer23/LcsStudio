...
/*!
 * \var xcsf_classifier_system* XCS
 * the XCSF classifier system
 */

xcsf_classifier_system* XCS;
...
{
	string		suffix = "maze"; 		//! configuration file suffix
	...
	//! init the prediction functions
	xcsflib::config(xcs_config2);
	if (flag_verbose) 
		cout << "Prediction Function    \t\tok." << endl;
...
// 	XCS = new xcs_classifier_system(xcs_config2);
 	if (flag_verbose) 
